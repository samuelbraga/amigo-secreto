...
export const USER_TOKEN_CREDENTIALS_DOES_NOT_EXISTS_TYPE = "user.token.credentials";
export const USER_TOKEN_CREDENTIALS_DOES_NOT_EXISTS_TITLE = "Token do usuário não existe";
export const USER_TOKEN_CREDENTIALS_DOES_NOT_EXISTS_DETAIL = "O token informado não existe para este usuário";

export const USER_TOKEN_CREDENTIALS_EXPIRED_TYPE = "user.token.credentials.expired";
export const USER_TOKEN_CREDENTIALS_EXPIRED_TITLE = "Token expirado";
export const USER_TOKEN_CREDENTIALS_EXPIRED_DETAIL = "O token informado expirou";
...
export const INCORRECT_CREDENTIALS_DETAIL = "As credenciais informadas não correspondem";
